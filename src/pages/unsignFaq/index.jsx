...
`;
  ...
  `;
  const title4=`
  4. What are the differences between Keyword and Lookalike Audience expansion?
`;
  const text4 = `
            ...
            <Col xs={24} xl={20} lg={20} style={{marginTop: 40, margin: '32px auto'}}>
              <Collapse
                ...
                <Panel header={title1} key="1" extra={
                  activeKey.includes('1')?<UpCircleFilled style={{fontSize: 18}}/>:
                  <RightCircleOutlined style={{fontSize: 18}}/>
                }>
                  <p className="fdq-text">{text1}</p>
                </Panel>
              </Collapse>
              <Collapse
                className="faq-collapse"
                ...
                <Panel header={title2} key="2" extra={activeKey.includes('2')?<UpCircleFilled style={{fontSize: 18}}/>:
                  <RightCircleOutlined style={{fontSize: 18}}/>}>
                  <p className="fdq-text">{text2}</p>
                </Panel>
              </Collapse>
              <Collapse
                className="faq-collapse"
                ...
                <Panel header={title3} key="3" extra={activeKey.includes('3')?<UpCircleFilled style={{fontSize: 18}}/>:
                  <RightCircleOutlined style={{fontSize: 18}}/>}>
                  <p className="fdq-text">{text3}</p>
                </Panel>
              </Collapse>
              ...
              <Collapse
                ...
                <Panel header={title4} key="4" extra={activeKey.includes('4')?<UpCircleFilled style={{fontSize: 18}}/>:
                  <RightCircleOutlined style={{fontSize: 18}}/>}>
                  <p className="fdq-text">{text4}</p>
                </Panel>
              </Collapse>
              ...
              <Collapse
                ...
                <Panel header={title5} key="5" extra={activeKey.includes('5')?<UpCircleFilled style={{fontSize: 18}}/>:
                  <RightCircleOutlined style={{fontSize: 18}}/>}>
                  <p className="fdq-text">{text5}</p>
                </Panel>
              </Collapse>
            </Col>
          </Row>
